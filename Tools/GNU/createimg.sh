...
{
	gcc ../makeimgsource/makeimg.c -lpthread -Wall -O2 -o ../makeimg
	gcc ../makeimgsource/makeimg_all.c -lpthread -Wall -O2 -o ../makeimg_all	
	gcc ../makeimgsource/makeimg_dbg.c -lpthread -Wall -O2 -o ../makeimg_dbg
}
fi
